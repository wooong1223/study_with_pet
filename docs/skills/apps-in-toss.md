...
- [개발하기](https://developers-apps-in-toss.toss.im/tosspixel/develop.md): 토스애즈 픽셀 연동 개발 가이드입니다.
...
- [알림 동의문 요청 (`requestNotificationAgreement`)](https://developers-apps-in-toss.toss.im/bedrock/reference/framework/인터렉션/requestNotificationAgreement.md): requestNotificationAgreement는 사용자에게 알림 수신 동의 UI를 요청하는 함수예요. 재입고 알림, 이벤트 시작 알림처럼 사전 동의가 필요한 경우에 사용해요.
...
- [유입경로 레퍼러](https://developers-apps-in-toss.toss.im/bedrock/reference/framework/분석/referrer.md): 미니앱으로 유입될 때 전달되는 appsintoss_referrer 값의 종류와 의미를 설명해요.
